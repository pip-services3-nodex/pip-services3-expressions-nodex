...
class TypeUnsafeVariantOperations extends AbstractVariantOperations_1.AbstractVariantOperations {
    ...
    convert(value, newType) {
        ...
        if (newType == VariantType_1.VariantType.String) {
            let result = new Variant_1.Variant();
            result.asString = pip_services3_commons_nodex_1.StringConverter.toString(value.asObject);
            return result;
        }
        switch (value.type) {
    ...
    convertFromString(value, newType) {
        ...
        switch (newType) {
            case VariantType_1.VariantType.Integer:
                result.asInteger = pip_services3_commons_nodex_2.IntegerConverter.toInteger(value.asString);
                return result;
            case VariantType_1.VariantType.Long:
                result.asLong = pip_services3_commons_nodex_3.LongConverter.toLong(value.asString);
                return result;
            case VariantType_1.VariantType.Float:
                result.asFloat = pip_services3_commons_nodex_4.FloatConverter.toFloat(value.asString);
                return result;
            case VariantType_1.VariantType.Double:
                result.asDouble = pip_services3_commons_nodex_5.DoubleConverter.toDouble(value.asString);
                return result;
            case VariantType_1.VariantType.DateTime:
                result.asDateTime = pip_services3_commons_nodex_6.DateTimeConverter.toDateTime(value.asString);
                return result;
            case VariantType_1.VariantType.TimeSpan:
                result.asTimeSpan = pip_services3_commons_nodex_3.LongConverter.toLong(value.asString);
                return result;
            case VariantType_1.VariantType.Boolean:
                result.asBoolean = pip_services3_commons_nodex_7.BooleanConverter.toBoolean(value.asString);
                return result;
        }
        throw new Error("Variant convertion from " + this.typeToString(value.type)
            + " to " + this.typeToString(newType) + " is not supported.");
    ...
    convertFromDateTime(value, newType) {
        ...
        switch (newType) {
            ...
            case VariantType_1.VariantType.Long:
                ...
                return result;
            case VariantType_1.VariantType.String:
                result.asString = pip_services3_commons_nodex_1.StringConverter.toString(value.asDateTime);
                return result;
        }
        throw new Error("Variant convertion from " + this.typeToString(value.type)
            + " to " + this.typeToString(newType) + " is not supported.");
    ...
    convertFromTimeSpan(value, newType) {
        ...
        switch (newType) {
            ...
            case VariantType_1.VariantType.Long:
                ...
                return result;
            case VariantType_1.VariantType.String:
                result.asString = pip_services3_commons_nodex_1.StringConverter.toString(value.asTimeSpan);
                return result;
        }
        throw new Error("Variant convertion from " + this.typeToString(value.type)
            + " to " + this.typeToString(newType) + " is not supported.");
