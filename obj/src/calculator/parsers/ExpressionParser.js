        ...
        for (let token of this._originalTokens) {
            ...
            switch (token.type) {
                ...
                case TokenType_1.TokenType.Integer:
                    {
                        tokenType = ExpressionTokenType_1.ExpressionTokenType.Constant;
                        tokenValue = Variant_1.Variant.fromInteger(pip_services3_commons_nodex_1.IntegerConverter.toInteger(token.value));
                        break;
                    }
                case TokenType_1.TokenType.Float:
                    {
                        tokenType = ExpressionTokenType_1.ExpressionTokenType.Constant;
                        tokenValue = Variant_1.Variant.fromFloat(pip_services3_commons_nodex_2.FloatConverter.toFloat(token.value));
                        break;
                    }
