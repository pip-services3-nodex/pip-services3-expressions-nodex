...
suite('DefaultFunctionCollection', () => {
    ...
    test('DateFunctions', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        assert.equal(VariantType_1.VariantType.DateTime, result.type);
        assert.equal(pip_services3_commons_nodex_1.StringConverter.toString(new Date(1975, 3, 8)), pip_services3_commons_nodex_1.StringConverter.toString(result.asDateTime));
    }));
});
